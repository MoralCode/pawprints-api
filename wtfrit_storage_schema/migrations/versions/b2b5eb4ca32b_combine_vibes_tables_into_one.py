...
def upgrade() -> None:
    ...
    with op.batch_alter_table('vibes', schema=None, recreate='auto') as batch_op:
        batch_op.add_column(sa.Column('parent_id', sa.Integer(), nullable=True))
        batch_op.create_foreign_key('vibes', 'vibes', ['parent_id'], ['id'])
...
def downgrade() -> None:
    ...
    # ### commands auto generated by Alembic - please adjust! ###
        ...
        batch_op.create_table('comment_vibes',
